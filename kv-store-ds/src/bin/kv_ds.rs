...
use kv_store_ds::{
    ...
    cornflakes_dynamic::CornflakesDynamicSerializer,
    flatbuffers::FlatBufferSerializer,
    //protobuf::ProtobufSerializer
    KVSerializer,
    KVServer,
    SerializedRequestGenerator,
    YCSBClient,
};
use std::{
    net::Ipv4Addr,
...
#[structopt(
    name = "KV Data structure Store App.",
    about = "KV store server and client."
)]
struct Opt {
    #[structopt(
        short = "debug",
