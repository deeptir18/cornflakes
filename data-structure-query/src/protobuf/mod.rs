pub mod ds_query_messages {
    ...
    include!(concat!(env!("OUT_DIR"), "/ds_query_proto.rs"));
}
...
fn check_tree5l(
    indices: &[usize],
    payloads: &Vec<Vec<u8>>,
    object: &ds_query_messages::Tree5LProto,
) {
...
fn check_tree4l(
    indices: &[usize],
    payloads: &Vec<Vec<u8>>,
    object: &ds_query_messages::Tree4LProto,
) {
...
fn check_tree3l(
    indices: &[usize],
    payloads: &Vec<Vec<u8>>,
    object: &ds_query_messages::Tree3LProto,
) {
...
fn check_tree2l(
    indices: &[usize],
    payloads: &Vec<Vec<u8>>,
    object: &ds_query_messages::Tree2LProto,
) {
...
fn check_tree1l(
    indices: &[usize],
    payloads: &Vec<Vec<u8>>,
    object: &ds_query_messages::Tree1LProto,
) {
...
fn check_single_buffer(
    idx: usize,
    payloads: &Vec<Vec<u8>>,
    object: &ds_query_messages::SingleBufferProto,
) {
...
fn get_tree_5l_message<'a>(
    indices: &[usize],
    payloads: &Vec<&'a [u8]>,
) -> ds_query_messages::Tree5LProto {
    let mut tree_5l = ds_query_messages::Tree5LProto::new();
...
fn get_tree_4l_message<'a>(
    indices: &[usize],
    payloads: &Vec<&'a [u8]>,
) -> ds_query_messages::Tree4LProto {
    let mut tree_4l = ds_query_messages::Tree4LProto::new();
...
fn get_tree_3l_message<'a>(
    indices: &[usize],
    payloads: &Vec<&'a [u8]>,
) -> ds_query_messages::Tree3LProto {
    let mut tree_3l = ds_query_messages::Tree3LProto::new();
...
fn get_tree_2l_message<'a>(
    indices: &[usize],
    payloads: &Vec<&'a [u8]>,
) -> ds_query_messages::Tree2LProto {
    let mut tree_2l = ds_query_messages::Tree2LProto::new();
...
fn get_tree_1l_message<'a>(
    indices: &[usize],
    payloads: &Vec<&'a [u8]>,
) -> ds_query_messages::Tree1LProto {
    let mut tree_1l = ds_query_messages::Tree1LProto::new();
...
fn get_single_buffer_message<'a>(
    idx: usize,
    payloads: &Vec<&'a [u8]>,
) -> ds_query_messages::SingleBufferProto {
    let mut single_buffer_proto = ds_query_messages::SingleBufferProto::new();
    single_buffer_proto.set_message(payloads[idx].to_vec());
    single_buffer_proto
}

fn deserialize_tree5l(input: &ds_query_messages::Tree5LProto) -> ds_query_messages::Tree5LProto {
    let mut output = ds_query_messages::Tree5LProto::new();
    output.set_left(deserialize_tree4l(&input.get_left()));
    output.set_right(deserialize_tree4l(&input.get_right()));
    output
}

fn deserialize_tree4l(input: &ds_query_messages::Tree4LProto) -> ds_query_messages::Tree4LProto {
    let mut output = ds_query_messages::Tree4LProto::new();
    output.set_left(deserialize_tree3l(&input.get_left()));
    output.set_right(deserialize_tree3l(&input.get_right()));
    output
}

fn deserialize_tree3l(input: &ds_query_messages::Tree3LProto) -> ds_query_messages::Tree3LProto {
    let mut output = ds_query_messages::Tree3LProto::new();
    output.set_left(deserialize_tree2l(&input.get_left()));
    output.set_right(deserialize_tree2l(&input.get_right()));
    output
}

fn deserialize_tree2l(input: &ds_query_messages::Tree2LProto) -> ds_query_messages::Tree2LProto {
    let mut output = ds_query_messages::Tree2LProto::new();
    output.set_left(deserialize_tree1l(&input.get_left()));
    output.set_right(deserialize_tree1l(&input.get_right()));
    output
}

fn deserialize_tree1l(input: &ds_query_messages::Tree1LProto) -> ds_query_messages::Tree1LProto {
    let mut output = ds_query_messages::Tree1LProto::new();
...
fn deserialize_single_buffer(
    input: &ds_query_messages::SingleBufferProto,
) -> ds_query_messages::SingleBufferProto {
    let mut single_buffer_proto = ds_query_messages::SingleBufferProto::new();
    ...
    fn process_msg<'registered, 'normal: 'registered>(
        ...
        match self.message_type {
            SimpleMessageType::Single => {
                let object_deser = ds_query_messages::SingleBufferProto::parse_from_bytes(
                    recved_msg.get_pkt_buffer(),
                )
                .wrap_err("Failed to deserialize single buffer proto.")?;
                let mut object_ser = ds_query_messages::SingleBufferProto::new();
            ...
            SimpleMessageType::List(_list_elts) => {
                let object_deser =
                    ds_query_messages::ListProto::parse_from_bytes(recved_msg.get_pkt_buffer())
                        .wrap_err("Failed to deserialize list proto.")?;
                let mut object_ser = ds_query_messages::ListProto::new();
            ...
            SimpleMessageType::Tree(depth) => match depth {
                TreeDepth::One => {
                    let object_deser = ds_query_messages::Tree1LProto::parse_from_bytes(
                        recved_msg.get_pkt_buffer(),
                    )
                ...
                TreeDepth::Two => {
                    let object_deser = ds_query_messages::Tree2LProto::parse_from_bytes(
                        recved_msg.get_pkt_buffer(),
                    )
                    .wrap_err("Failed to deserialize Tree1LProto.")?;
                ...
                TreeDepth::Three => {
                    let object_deser = ds_query_messages::Tree3LProto::parse_from_bytes(
                        recved_msg.get_pkt_buffer(),
                    )
                    .wrap_err("Failed to deserialize Tree1LProto.")?;
                ...
                TreeDepth::Four => {
                    let object_deser = ds_query_messages::Tree4LProto::parse_from_bytes(
                        recved_msg.get_pkt_buffer(),
                    )
                    .wrap_err("Failed to deserialize Tree1LProto.")?;
                ...
                TreeDepth::Five => {
                    let object_deser = ds_query_messages::Tree5LProto::parse_from_bytes(
                        recved_msg.get_pkt_buffer(),
                    )
                    .wrap_err("Failed to deserialize Tree1LProto.")?;
    ...
    fn init(&mut self, ctx: &'normal mut Self::Ctx) -> Result<()> {
        ...
        match self.message_type {
            ...
            SimpleMessageType::List(list_elts) => {
                ...
                let mut list_proto = ds_query_messages::ListProto::new();
