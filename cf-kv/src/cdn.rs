...
pub fn cdn_keys(total_keys: usize, key_length: usize) -> Vec<String> {
...
impl CdnClient {
    pub fn new(total_keys: usize, key_length: usize) -> Self {
        ...
        CdnClient { keys, key_distr }
    }
}

impl Default for CdnClient {
    fn default() -> Self {
        CdnClient::new(DEFAULT_NUM_KEYS, DEFAULT_KEYS_SIZE)
    }
}
#[derive(Debug, PartialEq, Eq, Clone)]
