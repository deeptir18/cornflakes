    ...
    match opt.datapath {
        NetworkDatapath::DPDK => {
            ...
            let mut datapath_params =
                <DpdkConnection as Datapath>::parse_config_file(&opt.config_file, &opt.our_ip)?;
            ...
            let per_thread_contexts = <DpdkConnection as Datapath>::global_init(
                opt.num_threads,
                &mut datapath_params,
                addresses,
            )?;
                ...
                .enumerate()
            {
                ...
                threads.push(spawn(move || {
                    ...
                    let mut echo_client: SimpleEchoClient<DpdkConnection> =
